$(document).ready(function(){
	...
	// 	alert("sadf");
	// });
	$("#generateControllerFile").click(Files.GenerateItemFile);
	$("#generateModelFile").click(Files.GenerateItemFile);
	$("#generateRequestFile").click(Files.GenerateItemFile);
	
	$("#generateCreateViewFile").click(Files.GenerateItemFile);
	$("#generateIndexViewFile").click(Files.GenerateItemFile);
	$("#generateShowViewFile").click(Files.GenerateItemFile);
	$("#generateEditViewFile").click(Files.GenerateItemFile);
});
